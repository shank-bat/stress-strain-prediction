      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl w-full px-4">
        ...
        >
          <div className="flex flex-col items-center gap-4">
            <div className="w-20 h-20 rounded-full bg-primary/10 ring-1 ring-primary/25 shadow-lg shadow-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
