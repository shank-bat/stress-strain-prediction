#!/usr/bin/env python3
"""
Per-temperature training: trains one PCA+MLP model for each test temperature.
"""
...
for temp in temps:
    ...
    print(f"\n=== Training model for Temperature {temp} ===")
    ...
    pca = PCA(n_components=min(N_PCA, Y.shape[0]-1, Y.shape[1]))
